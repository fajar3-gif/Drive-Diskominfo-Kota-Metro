...
<body>
    ...
    <div class="main-container">
        ...
        @include('partials.dashboard._sidebar', ['activeMenu' => 'sampah'])
        ...
        <div class="main-content">
            ...
            <div style="display: flex; align-items: center; gap: 0; margin-bottom: 14px; overflow: hidden; white-space: nowrap; min-height: 32px;">
                <span style="flex-shrink: 0; font-size: 20px; font-weight: 600; color: #202124; padding: 4px 6px;">Sampah</span>
            </div>
            ...
            {{-- DAFTAR FOLDER & FILE --}}
            @include('partials.dashboard._file-list', ['activeMenu' => 'sampah'])
